...
class SNetU:
    ...
    def __init__(self, inputChannels, outputChannels, inputResolutionU, inputResolutionV, lastActivation= 'tanh'):
        ...
        self.downsample(64, 3,strides=1),  # (bs, 128, 128, 64)
        self.downsample(128, 3), # (bs, 64, 64, 128)
        self.downsample(128, 3,strides=1), # (bs, 32, 32, 256)
        ]

        up_stack = [
     self.upsample(128, 3,strides=1) ,# (bs, 128, 128, 64)
        self.upsample(128, 3),
        self.upsample(64, 3,strides=1),  # (bs, 256, 256, 32)
        self.upsample(64, 3),
        self.upsample(75, 3),
        ]
        final_stack=[self.upsample(32, 3,strides=2),self.upsample(32, 3,strides=1)]
        initializer = tf.random_normal_initializer(0., 0.02)
